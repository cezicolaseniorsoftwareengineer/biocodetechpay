...
class User(Base):
    ...
    balance: Mapped[float] = mapped_column("saldo", Numeric(15, 2, asdecimal=False), default=0.00, nullable=False)
    credit_limit: Mapped[float] = mapped_column("limite_credito", Numeric(15, 2, asdecimal=False), default=10000.00, nullable=False)
